...
export default class Wheel extends Component {
  ...
  renderItem(item, itemIndex) {
    ...
    // console.log('当前第', itemIndex, '是否显示');
    // console.log(!(Math.abs(this.index - itemIndex) > this.hiddenOffset));
  ...
  renderHoleLine() {
    ...
    if (holeLine === undefined) {
      holeLine = <View style={{height: 1, backgroundColor: 'black'}} />;
    } else if (typeof holeLine === 'number') {
      holeLine = <View style={{height: holeLine, backgroundColor: 'black'}} />;
    }
    return holeLine;
  }
