...
const DrawerContainer = forwardRef<DrawerContainerRef, DrawerContainerProps> ((props, ref) => {
  const {position, duration = 250, onAppear, containerStyle, children, onDisappear} = props;
  ...
  return (
    <View style={styles.mask}>
      <Animated.View 
        style={[styles.overlay, initialPosition]}
      >
