...
const ProgressExample: React.FC<ProgressExampleProps> = props => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Section title="条状进度条渐变" style={{ paddingVertical: 30 }}>
        <Progress width={180} height={20} style={{ marginVertical: 10 }} value={60} activeColor={['#eea6b7', '#e9ccd3']} inactiveColor='#F8F8F8' radius />
      </Section>
      <Section title="条状进度条动画" style={{ paddingVertical: 30 }}>
        <Progress 
          delay={3000} 
          duration={3000} 
          width={300} 
      ...
      <Section title="圆形进度条渐变" style={{ paddingVertical: 30 }}>
        <CircleProgress 
          size={60} 
          value={100} 
